...
import requests
# from zr_amazon_scraper import AmazonScraper
from zr_amazon_scraper.scraper import AmazonScraper
# from zr_web_scraper.zr_amazon_scraper import AmazonScraper
...
class TestAmazonScraper(unittest.TestCase):
    ...
    # @patch('scraper.amazon_scraper.scraper.requests.get')
    @patch('zr_amazon_scraper.scraper.requests.get')
